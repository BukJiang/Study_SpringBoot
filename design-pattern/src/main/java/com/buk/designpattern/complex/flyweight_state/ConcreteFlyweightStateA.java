 ...
 **/
@Slf4j
public class ConcreteFlyweightStateA extends FlyweightState {
    ...
    public void handle(FlyweightContext flyweightContext) {
        log.info("[具体享元状态]A");
        flyweightContext.setFlyweightState(flyweightContext.getFlyweightState("ConcreteFlyweightStateB"));
    }
}
