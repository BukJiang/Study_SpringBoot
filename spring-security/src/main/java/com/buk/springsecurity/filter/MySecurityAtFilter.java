 ...
 */
@Slf4j
public class MySecurityAtFilter extends AbstractAuthenticationProcessingFilter {

    public MySecurityAtFilter(
            MySecurityAuthenticationManager mySecurityAuthenticationManager
    ) {
        super(new AntPathRequestMatcher("/security/require/authorize/1"));
        // 安全认证管理器
    ...
    public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain) throws IOException, ServletException {
        log.info("[安全过滤器:MySecurityAtFilter] - doFilter");
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException, IOException, ServletException {
        log.info("[安全过滤器:MySecurityAtFilter] - attemptAuthentication");
        return null;
    }
}
