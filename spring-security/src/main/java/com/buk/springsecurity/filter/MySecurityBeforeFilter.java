 ...
 */
@Slf4j
public class MySecurityBeforeFilter extends AbstractAuthenticationProcessingFilter {

    public MySecurityBeforeFilter(
    ...
    public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain) throws IOException, ServletException {
        log.info("[安全过滤器:MySecurityBeforeFilter] - doFilter");
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException, IOException, ServletException {
        log.info("[安全过滤器:MySecurityBeforeFilter] - attemptAuthentication");
        return null;
    }
}
